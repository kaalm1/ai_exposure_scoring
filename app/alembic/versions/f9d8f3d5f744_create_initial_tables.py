...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_ai_scores_company_name'), 'ai_scores', ['company_name'], unique=False)
    op.create_index(op.f('ix_ai_scores_filter_decision'), 'ai_scores', ['filter_decision'], unique=False)
